...
// import { mapActions, mapState } from 'vuex'; // mapGetters, mapMutations

const { mapActions, mapState } = createNamespacedHelpers('ProductsModule');
...
export default {
  ...
  computed: {
    ...
    // ...mapState({
    //   categories: state => state.ProductsModule.categories,
